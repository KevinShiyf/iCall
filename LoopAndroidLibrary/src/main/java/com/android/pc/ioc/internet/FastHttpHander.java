...
//	}
	...
	//Kevin add
	public static void ajax(String url, String params, Object object) {
		ajax(url, params, InternetConfig.defaultConfig(), object);
	}
	...
	//Kevin add
	public static void ajax(String url, String params, final InternetConfig config, final Object object) {
		config.setRequest_type(InternetConfig.request_post);
		AjaxCallBack callBack = new AjaxCallBack() {
			@Override
			public void callBack(ResponseEntity status) {
